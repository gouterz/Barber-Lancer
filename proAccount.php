...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['city']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])){
    ...
    $redirectURL = ($sessData['status']['type'] == 'success')?'proindex.php':'profreg.php';
